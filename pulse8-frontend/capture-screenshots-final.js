...
const MAIN_PAGES = [
  ...
  { path: '/marketing/assets/upload', name: 'marketing-assets-upload', auth: true },
  { path: '/marketing/schedules', name: 'marketing-schedules', auth: true },
  ...
  { path: '/team/1', name: 'team-detail', auth: true },
  ...
  { path: '/promoters/1', name: 'promoters-detail', auth: true },
  ...
  { path: '/admin/roles/create', name: 'admin-roles-create', auth: true },
  { path: '/admin/access', name: 'admin-access', auth: true },
  { path: '/admin/access/create', name: 'admin-access-create', auth: true }
];
...
async function loginAndCapture(page, credentials) {
  ...
  // Aguardar redirecionamento - tempo aumentado
  ...
  if (currentUrl.includes('/dashboard')) {
    ...
    console.log(`❌ Login falhou - ainda em: ${currentUrl}`);
    return false;
  }
}
