...
export default function CampaignsPage() {
  ...
  const handleDeleteClick = (campaign: CampaignDto) => {
  ...
  return (
    <div className="space-y-6 overflow-x-hidden">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Campanhas de Marketing</h1>
          <p className="text-sm sm:text-base text-gray-600">Gerencie suas campanhas de marketing</p>
        </div>
        <Link href="/marketing/campaigns/create" className="flex-shrink-0">
            ...
            <Card key={campaign.id} className="hover:shadow-lg transition-shadow">
              <CardContent className="p-6">
                ...
                <div className="flex gap-2">
                  <Link href={`/marketing/campaigns/${campaign.id}`} className="flex-1">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-4 lg:gap-6">
                      ...
                      {campaign.budget && (
                        <div className="text-center">
                          ...
                          <p className="font-semibold text-sm sm:text-base truncate">{formatCurrency(campaign.budget)}</p>
                        </div>
                      )}
                    </div>
                    {/* Status and Actions */}
